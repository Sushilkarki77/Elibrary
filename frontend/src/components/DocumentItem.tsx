    ...
    return (
        <tr className="border-b border-gray-300 hover:bg-gray-50">
            ...
            <td className="px-2 py-2 text-sm text-gray-800 flex gap-2">
                ...
                <button onClick={() => onDisplayOriginalFile(document._id)} className="px-2 py-1 text-xs text-blue-600  hover:text-blue-800 transition duration-200">
                    View
                </button>
                <button onClick={() => onGenerateSummary(document._id)} className="px-2 py-1 text-xs text-teal-600  hover:text-teal-800 transition duration-200">
                    Summary
                </button>
                <button onClick={() => onGenerateQuiz(document._id)} className="px-2 py-1 text-xs text-green-600  hover:text-green-800 transition duration-200">
                    Quiz
                </button>
                <button onClick={() => onDeleteClick(document._id)} className="px-2 py-1 text-xs text-red-600  hover:text-red-800 transition duration-200">
                    Delete
                </button>
